...
export default function Panel({ children }) {
  ...
  return (
    <div
      className={`max-w-screen flex min-h-screen grid-rows-1 flex-col items-start items-center overflow-y-hidden bg-light-bg dark:bg-dark-bg sm:grid sm:items-start sm:gap-y-8 ${font.className}`}
      style={{
